...
def full_path(origin, pgm):
    p = []
    o = origin
    for i in pgm:
        op = parse(i)
        next_p = path(o,op)
#        print('op={} -> {}'.format(op,next_p))
        p.extend(next_p)
        o = next_p[-1] 
    return p
...
#x1 = ['R8','U5','L5','D3']
#x2 = ['U7','R6','D4','L4']
# x1 = ['R75','D30','R83','U83','L12','D49','R71','U7','L72']
# x2 = ['U62','R66','U55','R34','D71','R55','D58','R83']
# x1 =['R98','U47','R26','D63','R33','U87','L62','D20','R33','U53','R51']
# x2 = ['U98','R91','D20','R16','D67','R40','U7','R15','U6','R7']
x1 = w1
x2 = w2
# find pull paths origin->{x1,x2}
p1 = full_path(zero,x1)
p2 = full_path(zero,x2)
print('x1={}, x2={}'.format(p1,p2))
# intsecting points
s1 = set(p1)
s2 = set(p2)
ii = s1 & s2
# idx into p_i for ii 
ii_idx = [ (i,p1.index(i),p2.index(i)) for i in ii ]
print('intersect at {}'.format(ii_idx))
sums = [ (idx1+idx2+2) for (p,idx1,idx2) in ii_idx ]
print('answer {}'.format(min(sums)))
